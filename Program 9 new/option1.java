...
class option1 extends JFrame implements MouseListener,MouseMotionListener ,ActionListener
{
	JFrame f;
	JLabel l;
	JPanel p1;
	...
	int rgb;
	int frgb[]=new int[5];
	String fea[]=new String[5];	
	int count=0;
	String ss;
	int ccb=0;
	Graphics2D gg1,gg2,gg3,gg4;
	...
	option1()
	{	
		f=new JFrame("Style 1 to open an image");
		...
		pp2.addPoint(200,280);
		pp2.addPoint(230,280);
		pp2.addPoint(240,260);
		pp2.addPoint(230,240);
		pp2.addPoint(210,235);
		pp2.addPoint(180,250);
		
		pp3.addPoint(130,400);
		pp3.addPoint(180,420);
		pp3.addPoint(150,380);

		pp4.addPoint(340,80);
		pp4.addPoint(200,100);
	...
	{	  
	  boolean contain1,contain2,contain3,contain4;
	  ...
	  contain4=pp4.contains(x,y);
	  System.out.print("\nPoint inside polygon:"+(contain1||contain2||contain3||contain4)+"\n");
	  ...
	  else if(contain3==true)
	  {
 	  ...
 	  else if(contain4==true)
	  {
		Color color = new Color(128, 128,128);
		rgb = color.getRGB(); 
		tf1.setBackground(new Color(128, 128,128));
	  }
	  else
...

	{
		...
		gg3.fillPolygon(pp3);
		gg4=(Graphics2D)l.getGraphics();	
		gg4.setColor(new Color(128,128,128) );
		gg4.fillPolygon(pp4);
