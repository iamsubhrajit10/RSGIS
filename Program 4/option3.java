...
class option3 extends JFrame implements MouseListener,MouseMotionListener ,ActionListener
{
	JFrame f;
	JLabel l;
	JPanel p1;
	...
	option3()
	{	
		f=new JFrame("Style 3 to open an image");
		...
		pp1.addPoint(130,400);
		pp1.addPoint(180,420);
		pp1.addPoint(150,380);
		
		pp2.addPoint(300,300);
		pp2.addPoint(340,300);
		pp2.addPoint(340,260);
		pp2.addPoint(300,260);
