...
class page3 extends JFrame implements ActionListener,ItemListener 
{
  JFrame f;
  ...
  page3(String aa, String bb)
  {
  	nam=aa;
  	course=bb;
  	f=new JFrame("Page Design 3");
  	f.setSize(500,400);
	...
	String ht11 = 
        "<html><p><font color=\"GREEN\" "+
        "size=\"6\" face=\"Verdana\">Enter Address</font> </p>";
	...
	String ht21 = 
        ...
        "size=\"6\" face=\"Verdana\">Are you an NRI?</font> </p>";
   ...
   public void actionPerformed(ActionEvent ae)
    {
  	...
  	if(ae.getSource()==b1)
		...
		String ss1 =(String)cb1.getSelectedItem();
  		if(st1.length()==0)
  		{
  		JOptionPane.showMessageDialog((Component)null,"Please  enter your address",
   	          "NOTIFICATION",JOptionPane.ERROR_MESSAGE);
   	          flag=1;	
  		}
  		if(ss1.equals("Select"))
  		{
  			JOptionPane.showMessageDialog((Component)null,"Please  Select are you an NRI or not",
   	          "NOTIFICATION",JOptionPane.ERROR_MESSAGE);
   	          flag=1;
  		}
  		if(flag==0)
