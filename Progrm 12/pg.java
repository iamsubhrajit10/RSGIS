...
class pg extends JFrame implements MouseListener,MouseMotionListener ,ActionListener
{
JFrame f;
JLabel l;
JPanel p1;
...
int rgb;
int noOfFeatures = 4;
int frgb[]=new int[noOfFeatures];
String fea[]=new String[noOfFeatures];
int count=0;
String ss;
int ccb=0;
pg()
{
f=new JFrame("Feature selection Page");
...
"size=\"4\" face=\"Arial\">Feature Selection</font> </p>";
leb1=new JLabel(ht1);
p1a.add(leb1);
cb1a=new JComboBox();
...
String ht2 =
"<html><p><font color=\"BLUE\" "+
"size=\"4\" face=\"Arial\">Color</font> </p>";
leb2=new JLabel(ht2);
p1b.add(leb2);
...
String ht3 =
"<html><p><font color=\"BLUE\" "+
"size=\"4\" face=\"Arial\">Feature</font> </p>";
leb3=new JLabel(ht3);
p1b.add(leb3);
...
fcb=new JButton(" G O ");
fcb.setBackground(Color.MAGENTA);
...
System.out.print("\n[ x = "+x+" ; y = "+y+" ; Icon Width = "+ii.getIconWidth());
rgb=(md.getRGB(pixels[a1]));
Color color = new Color(rgb);
System.out.println(" ; a1 = "+a1+" ; RGB = "+rgb+" ]");
...
{
int flag=0;
if(count==noOfFeatures)
{
JOptionPane.showMessageDialog((Component)null,"Feature assignments isn't complete yet..","NOTIFICATION",JOptionPane.ERROR_MESSAGE);
flag=1;
tf1.setBackground(Color.white);
tf2.setText(null);
}
...
{
JOptionPane.showMessageDialog((Component)null,"Please Assign Feature Name..","NOTIFICATION",JOptionPane.ERROR_MESSAGE);
flag=1;
}
if(rgb==0&&flag==0)
{
JOptionPane.showMessageDialog((Component)null,"Please Select Feature..","NOTIFICATION",JOptionPane.ERROR_MESSAGE);
flag=1;
}
if(flag==0)
{
...
if(rgb==frgb[i])
{
JOptionPane.showMessageDialog((Component)null,"Please Select New Feature..","NOTIFICATION",JOptionPane.ERROR_MESSAGE);
flag=1;
}
if(ss.equalsIgnoreCase(fea[i]))
{
JOptionPane.showMessageDialog((Component)null,"Feature Name is Used..","NOTIFICATION",JOptionPane.ERROR_MESSAGE);
flag=1;
tf2.setText(null);
}
}
...
if(count==noOfFeatures&&flag==0)
{
JOptionPane.showMessageDialog((Component)null,"Assignment complete","NOTIFICATION",JOptionPane.INFORMATION_MESSAGE);
tf1.setBackground(Color.white);
tf2.setText(null);
